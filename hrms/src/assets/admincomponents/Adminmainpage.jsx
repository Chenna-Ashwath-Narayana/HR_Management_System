...
import '../Admincomponentsstyles/Adminmainpage.css';
  ...
  return (
    <>
      <div className='adminpage-container'>
            ...
            <div className='sidebar-item'>
                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-stack" viewBox="0 0 16 16">
            ...
            <div className='sidebar-item'>
                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-envelope-paper-fill" viewBox="0 0 16 16">
                ...
                <Link to="adminleavemanagement">Leave Management</Link>
            </div>

            <div className='sidebar-item'>
                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-bar-chart-line-fill" viewBox="0 0 16 16">
                    <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1z"/>
                </svg>
                <Link to="adminattendance">Attendance</Link>
            </div>

            <div className='sidebar-item'>
                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-file-person-fill" viewBox="0 0 16 16">
                    <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2m-1 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-3 4c2.623 0 4.146.826 5 1.755V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-1.245C3.854 11.825 5.377 11 8 11"/>
                </svg>
                <Link to="adminclients">Clients</Link>
            </div>
            ...
            <div className='sidebar-item'>
                ...
                <Link to="adminpayroll">Payroll</Link>
            </div>
            
            <div className='sidebar-item'>
                <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-calendar-event" viewBox="0 0 16 16">
