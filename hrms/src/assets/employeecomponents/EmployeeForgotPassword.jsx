...
import "../employeecomponentsstyles/EmployeeForgotPassword.css"; // Reusing the same CSS for both Admin and Employee
...
const EmployeeForgotPassword = () => {
  ...
  const handlePasswordUpdate = async () => {
    ...
    try {
      const response = await axios.put("http://localhost:9000/employee/updatePassword", {
        employeeId: parseInt(employeeId), // Convert to number
